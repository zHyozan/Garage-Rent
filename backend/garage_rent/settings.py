...
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Garage Rent <no-reply@garagerent.local>")
...
WSGI_APPLICATION = "garage_rent.wsgi.application"
ASGI_APPLICATION = "garage_rent.asgi.application"
